...
urlpatterns = patterns('',
    ...
    url(r'^ajax/(?P<model_key>tournament|competition)/(?P<event_id>\d+)/add/tag/(?P<tag_id>\d+)/', add_tag_to_event, name='add_tag_to_event'),
    url(r'^ajax/(?P<model_key>tournament|competition)/(?P<event_id>\d+)/remove/tag/(?P<tag_id>\d+)/', remove_tag_from_event, name='remove_tag_from_event'),
