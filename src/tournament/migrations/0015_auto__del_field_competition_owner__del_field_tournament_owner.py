...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Tournament.owner'
        db.delete_column('tournament_tournament', 'owner_id')


    def backwards(self, orm):
        # Adding field 'Competition.owner'
        db.add_column('tournament_competition', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.ShareTree']),
                      keep_default=False)

        # Adding field 'Tournament.owner'
        db.add_column('tournament_tournament', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.ShareTree']),
                      keep_default=False)
    ...
    models = {
        ...
        'tournament.competition': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'blank': 'True', 'related_name': "'competitions'", 'symmetrical': 'False', 'to': "orm['tournament.Tag']"}),
            'tags_request': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'competition_requests'", 'to': "orm['tournament.Tag']"}),
            ...
            'tournament': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'blank': 'True', 'related_name': "'competitions'", 'on_delete': 'models.SET_NULL', 'to': "orm['tournament.Tournament']"})
        },
        ...
        'tournament.tag': {
            ...
            'subscribers': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'blank': 'True', 'related_name': "'subscribed_to'", 'symmetrical': 'False', 'to': "orm['auth.User']"})
        },
        ...
        'tournament.tournament': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'null': 'True', 'blank': 'True', 'related_name': "'tournaments'", 'symmetrical': 'False', 'to': "orm['tournament.Tag']"}),
            'tags_request': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'tournament_requests'", 'to': "orm['tournament.Tag']"})
        },
