...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.patronymic'
        db.add_column('relations_userprofile', 'patronymic',
                      self.gf('django.db.models.fields.CharField')(blank=True, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.patronymic'
        db.delete_column('relations_userprofile', 'patronymic')
    ...
    models = {
        ...
        'relations.ownrecord': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'own_records'", 'to': "orm['auth.User']", 'null': 'True'}),
        ...
        'relations.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'patronymic': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100', 'null': 'True'}),
            'primary_team': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['relations.Team']", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
