...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.external_read_auth'
        db.add_column('relations_userprofile', 'external_read_auth',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.external_read_auth'
        db.delete_column('relations_userprofile', 'external_read_auth')
    ...
    models = {
        ...
        'relations.userprofile': {
            ...
            'external_read_auth': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
