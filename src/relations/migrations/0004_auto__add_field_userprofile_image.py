...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('relations_userprofile', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=255, default='/media/user_picks/owl.jpg'),
                      keep_default=False)
    ...
    models = {
        ...
        'relations.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '255', 'default': "'owl.jpg'"}),
